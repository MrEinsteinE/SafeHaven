...
public class ShowBasicLawActivity extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_basic_law);
        ...
        closeBtn.setOnClickListener(view -> {
            onBackPressed();
            ShowBasicLawActivity.this.finish();
        });
